...
function addStrokes() {
  for (var _len = arguments.length, strokesToAdd = Array(_len), _key = 0; _key < _len; _key++) {
    strokesToAdd[_key] = arguments[_key];
  }

  strokesToAdd.forEach(function (stroke) {
    return strokes[stroke.id] = new _stroke2.default(stroke);
  });
}
...
_socket2.default.on("stroke", function (stroke) {
  log("Received stroke", stroke);
  addStrokes(stroke);
  render();
});

_socket2.default.on("strokes", function (strokes) {
  log("Received strokes", strokes);
  addStrokes.apply(undefined, _toConsumableArray(strokes));
  render();
});
...
var _last = require("../util/last");

var _last2 = _interopRequireDefault(_last);

var _randomInt = require("../util/random-int");
...
var Stroke = function () {
  function Stroke() {
    ...
    var _ref$id = _ref.id;
    var id = _ref$id === undefined ? _guid2.default.create().value : _ref$id;
    var _ref$color = _ref.color;
    var color = _ref$color === undefined ? { h: (0, _randomInt2.default)(0, 360), s: (0, _randomInt2.default)(50, 90), l: (0, _randomInt2.default)(50, 75) } : _ref$color;
    var _ref$width = _ref.width;
    var width = _ref$width === undefined ? (0, _randomInt2.default)(3, 6) : _ref$width;
    var _ref$segments = _ref.segments;
    var segments = _ref$segments === undefined ? [] : _ref$segments;

    _classCallCheck(this, Stroke);

    this.timestamp = Date.now();
    this.id = id;
    this.color = (0, _color2.default)(color);
    this.segments = segments.map(_victor2.default.fromObject);
    this.width = width;
  }

  _createClass(Stroke, [{
    key: "addSegment",
    value: function addSegment(point) {
      this.segments.push(_victor2.default.fromObject(point));
    }
  }, {
    key: "render",
    ...
    key: "lastSegment",
    get: function get() {
      return (0, _last2.default)(this.segments);
    }
  }]);
...
Stroke.render = function (ctx, stroke) {
...
},{"core-js/fn/regexp/escape":16,"core-js/shim":309,"regenerator-runtime/runtime":313}],5:[function(require,module,exports){
'use strict'
...
},{"base64-js":5,"ieee754":311,"isarray":7}],7:[function(require,module,exports){
...
},{"./css-keywords":10}],10:[function(require,module,exports){
module.exports = {
...
},{"./conversions":9,"./route":12}],12:[function(require,module,exports){
var conversions = require('./conversions');
...
},{"./conversions":9}],13:[function(require,module,exports){
module.exports = {
	"aliceblue": [240, 248, 255],
	"antiquewhite": [250, 235, 215],
	"aqua": [0, 255, 255],
...
},{"clone":8,"color-convert":11,"color-string":14}],16:[function(require,module,exports){
...
},{"_process":312}],314:[function(require,module,exports){
...
module.exports = function getMousePos(el, _ref) {
  ...
  return new _victor2.default(clientX - left, clientY - top);
};
